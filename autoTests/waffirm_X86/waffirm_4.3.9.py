...
res3 = WpaConnectWirelessNetwork(sta1,Netcard_sta1,Network_name1,connectType='open',checkDhcpAddress=Netcard_ipaddress_check,bssid=ap1mac_lower)
...
printCheckStep(testname, 'Step 4',not res3,not res4)
...
printCheckStep(testname, 'Step 6',not res3, not res4)
