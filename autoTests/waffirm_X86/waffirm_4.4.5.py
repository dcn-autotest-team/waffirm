...
#Step 1
#操作
# 在ac1配置network1的SSID为test1，关联vlan4092，下发配置。
# AP2断开网络连接
#
#预期
...
printStep(testname,'Step 1',\
          'Set network1 related to vlan 4092',\
          'AP2 connect to AC2')

res1=res2=1
#operate

#修改network1关联vlan为4092
...
#AP2 断开网络连接，此处采取shutdown s3p3端口
...
#operate
SetCmd(ap2,'set interface wlan0 ssid',Network_name1)
