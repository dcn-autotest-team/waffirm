...
#
#*******************************************************************************
# waffirm_4.3.6.py - test case 4.3.6 of waffirm
#
...
#
# Features:
# 4.3.6 WPA-Enterprise模式下客户端认证接入测试
# 测试目的：测试客户端通过WPA-Enterprise模式接入无线网络。
# 测试环境：同测试拓扑
# 测试描述：测试客户端通过WPA-Enterprise模式接入无线网络。
#           WPA version设置为WPA。（STA1的MAC地址：STA1MAC）
#
#*******************************************************************************
# Change log:
#     - 
...
for tmpCounter in xrange(0,10):
    ...
    if 0 == CheckLine(data,ap1mac_lower,'WPA-EAP',Network_name1):
        break
    
res1 = CheckLine(data,ap1mac_lower,'WPA-EAP',Network_name1)
