...
#
# Features:
# 1.4.2	wpa-personal方式下建立wds,使用wds0且数据vlan相同
#
#*******************************************************************************
# Change log:
...
testname = 'TestCase apwds_1.4.2'
avoiderror(testname)
printTimer(testname,'Start','Two ap both use vap0 to establish psk mode wds link and data traffic vlan is the same')
###############################################################################
#Step 1
#操作
# AP1上配置
