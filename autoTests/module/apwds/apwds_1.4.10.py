...
#
# Features:
# 1.4.10	wpa-personal方式下建立wds,修改satelliteap的加密密钥不一致，wds断开
#
#*******************************************************************************
# Change log:
...
testname = 'TestCase apwds_1.4.10'
avoiderror(testname)
printTimer(testname,'Start','Change wds-wpa-personal-key of satelliteap then wds psk mode wds should be unlinked')
###############################################################################
#Step 1
#操作
# AP2上进行psk模式的WDS配置
...
#Step 3
#操作
#AP2上修改wds-wpa-personal-key
# set wds wds0 wds-wpa-personal-key 11111111
#预期
# 等待40秒，WDS连接断开
################################################################################
...
#operate
Ap_set_wds(ap2,Ap2cmdtype,wds0num,'wds-wpa-personal-key','11111111')
IdleAfter(30)
