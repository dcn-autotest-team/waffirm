...
#
# Features:
# 1.4.3	wpa-personal方式下建立wds,使用wds0且数据vlan不同
#
#*******************************************************************************
# Change log:
...
testname = 'TestCase apwds_1.4.3'
avoiderror(testname)
printTimer(testname,'Start','Two ap both use vap0 to establish psk mode wds link and data traffic vlan is different')
###############################################################################
#Step 1
#操作
# AP1上配置
...
# 配置成功
################################################################################
printStep(testname,'Step 2','AP2 config wds0 as wpa-personal mode',\
...
res2 = WpaConnectWirelessNetwork(sta2,Netcard_sta2,Network_name2,checkDhcpAddress=Dhcp_pool2,bssid=ap2mac_type1_network3)
