...
#
# Features:
# 1.4.8	wpa-personal方式下建立wds,修改satelliteap的wds-ssid 不一致，wds断开
#
#*******************************************************************************
# Change log:
...
testname = 'TestCase apwds_1.4.8'
avoiderror(testname)
printTimer(testname,'Start','Change wds-ssid of satelliteap then psk mode wds should be unlinked')
###############################################################################
#Step 1
#操作
# AP2上进行psk模式的WDS配置
...
#操作
#AP2上修改wds-ssid
# set wds wds0 wds-ssid xxxxx
#预期
# 等待40秒，WDS连接断开
################################################################################
printStep(testname,'Step 3',\
                    'Change wds-ssid of AP2',\
                    'WDS should be unlinked')
res1=res2=res3=res4=1
#operate
Ap_set_wds(ap2,Ap2cmdtype,wds0num,'wds-ssid','xxxxx')
IdleAfter(30)
