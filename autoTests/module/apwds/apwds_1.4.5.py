...
#
# Features:
# 1.4.5	wpa-personal方式下建立wds,修改rootap的wds-ssid不一致，wds断开
#
#*******************************************************************************
# Change log:
...
testname = 'TestCase apwds_1.4.5'
avoiderror(testname)
printTimer(testname,'Start','Change wds-ssid of rootap then psk mode wds should be unlinked')
###############################################################################
#Step 1
#操作
# AP2上进行psk模式的WDS配置
...
#Step 3
#操作
#AC1上修改network 1的ssid，改为不同于原来的ssid
# 下发配置到AP1
#预期
#WDS连接断开
################################################################################
printStep(testname,'Step 3',\
                    'Change ssid in network 1',\
                    'Apply ap profile 1',\
