...
#
# Features:
# 1.4.4	wpa-personal方式下建立wds,修改rootap的remote-mac不一致，wds断开
#
#*******************************************************************************
# Change log:
...
testname = 'TestCase apwds_1.4.4'
avoiderror(testname)
printTimer(testname,'Start','Change wds-remote-vap of rootap then psk mode wds should be unlinked')
###############################################################################
#Step 1
#操作
# AP2上进行psk模式的WDS配置
...
#Step 3
#操作
#AC1上修改network 1的wds-remote-vap，改为不同于原来的MAC地址
# 下发配置到AP1
#预期
#WDS连接断开
################################################################################
printStep(testname,'Step 3',\
                    'Change wds-remote-vap in network 1',\
                    'Apply ap profile 1',\
                    'WDS should be unlinked')
res1=res2=res3=res4=1
#operate
EnterNetworkMode(switch1,1)    
SetCmd(switch1,'wds-remote-vap 00-03-0d-00-00-11')  
