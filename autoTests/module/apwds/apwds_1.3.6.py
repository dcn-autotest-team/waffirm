...
#
# Features:
# 1.3.6	Open方式下建立wds连接,修改rootap的认证方式不一致，wds断开
#
#*******************************************************************************
# Change log:
...
testname = 'TestCase apwds_1.3.6'
avoiderror(testname)
printTimer(testname,'Start','Change security mode of rootap then wds should be unlinked')
###############################################################################
#Step 1
#操作
# AP2上进行open模式的WDS配置
...
printStep(testname,'Step 3',\
                    'Change security mode in network 1',\
                    'Apply ap profile 1',\
