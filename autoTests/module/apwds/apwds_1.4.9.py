...
#
# Features:
# 1.4.9	wpa-personal方式下建立wds,修改satelliteap认证方式不一致，wds断开
#
#*******************************************************************************
# Change log:
...
testname = 'TestCase apwds_1.4.9'
avoiderror(testname)
printTimer(testname,'Start','Change wds-security-policy of satelliteap then psk mode wds should be unlinked')
###############################################################################
#Step 1
#操作
# AP2上进行psk模式的WDS配置
...
#operate
Ap_set_wds(ap2,Ap2cmdtype,wds0num,'wds-security-policy','plain-text')
IdleAfter(30)
