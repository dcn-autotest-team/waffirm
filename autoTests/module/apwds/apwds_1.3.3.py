...
#
# Features:
# 1.3.3	Open方式下建立wds连接,使用wds0且数据vlan不同
#
#*******************************************************************************
# Change log:
...
testname = 'TestCase apwds_1.3.3'
avoiderror(testname)
printTimer(testname,'Start','Two ap both use vap0 to establish wds link and data traffic vlan is different')
###############################################################################
#Step 1
#操作
# AP1上配置
