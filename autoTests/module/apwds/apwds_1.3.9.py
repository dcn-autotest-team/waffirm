...
#
# Features:
# 1.3.9	Open方式下建立wds连接,修改satelliteap的remote-mac为空，wds正常
#
#*******************************************************************************
# Change log:
...
testname = 'TestCase apwds_1.3.9'
avoiderror(testname)
printTimer(testname,'Start','Change remote-mac of satelliteap then wds should be still linked')
###############################################################################
#Step 1
#操作
# AP2上进行open模式的WDS配置
