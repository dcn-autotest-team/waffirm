...
#
# Features:
# 1.3.5	Open方式下建立wds连接,修改rootap的wds-ssid不一致，wds断开
#
#*******************************************************************************
# Change log:
...
testname = 'TestCase apwds_1.3.5'
avoiderror(testname)
printTimer(testname,'Start','Change wds-ssid of rootap then wds should be unlinked')
###############################################################################
#Step 1
#操作
# AP2上进行open模式的WDS配置
