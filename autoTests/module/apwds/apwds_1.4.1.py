...
#
# Features:
# 1.4.1	wpa-personal方式下建立wds,两AP均使用vap0，能够建立起wds连接
#
#*******************************************************************************
# Change log:
...
testname = 'TestCase apwds_1.4.1'
avoiderror(testname)
printTimer(testname,'Start','Two ap both use vap0 to establish psk mode wds link')
###############################################################################
#Step 1
#操作
# AP2上进行psk模式的WDS配置
