...
#
# Features:
# 4.1.13	WPA-Enterprise模式下客户端内置portal认证
# 测试目的：验证SSID采用WPA-Enterprise加密后开启portal认证，客户端连接网络能够正常进行内置portal认证
# 测试描述：
# 1、	开启内置portal认证。
# 2、	修改network1的加密方式为WPA-Enterprise
...
testname = 'TestCase internalportal_4.1.13'
avoiderror(testname)
