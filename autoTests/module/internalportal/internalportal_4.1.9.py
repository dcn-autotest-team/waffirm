...
#
# Features:
# 4.1.9	多vap的portal功能验证
# 测试目的：验证开启多个vap 的portal功能
# 测试描述：
# 1、	开启内置portal认证 
# 2、	新建多个network并且开启多个vap
# 3、	将新建立的network绑定到实例下
# 4、	STA1连接到任意一个SSID都可以成功进行portal认证
# 5、	关闭部分vap的portal功能
# 6、	STA1连接没有开启portal功能的vap无需认证可以直接上网
# 7、	STA1连接开启了portal功能的vap可以成功进行portal认证
# 测试环境：见测试环境拓扑图1
#*******************************************************************************
# Change log:
...
testname = 'TestCase internalportal_4.1.9'
avoiderror(testname)
printTimer(testname,'Start','Test multi-vap portal')
###############################################################################
#Step 1
# #操作
# 配置network3，并且开启profile 1的vap1、vap2： 
# AC1(config)#wireless                                                                                                                                                                                                            
# AC1(config-wireless)#network 3                                                                                                    
...
# 配置成功。
# 在AC1上通过命令
# show wireless network 2
# 可以看到network2的相关配置
# SSID为Network_name2  Default VLAN为Vlan4092
# show wireless network 3
# 可以看到network3的相关配置
...
res2 = CheckLine(data,'Default VLAN',Vlan4092)
#result
printCheckStep(testname, 'Step 1',res1,res2)
###############################################################################
#Step 2
#操作
# 将network2和network3绑定到实例下
...
#Step 6
#操作
# STA1断开AP1 Network_name2的连接
# STA1连接到AP1的Network_name3
#预期
# 关联成功。
