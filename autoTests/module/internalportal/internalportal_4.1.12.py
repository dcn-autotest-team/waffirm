...
#
# Features:
# 4.1.12	WPA和WPA2-Personal混合模式下客户端内置portal认证
# 测试目的：验证SSID采用WPA/WPA2-Personal加密后开启portal认证，客户端连接网络能够正常进行内置portal认证
# 测试描述：
# 1、	开启内置portal认证。
# 2、	修改network1的加密方式为WPA/WPA2-Personal
...
testname = 'TestCase internalportal_4.1.12'
avoiderror(testname)
