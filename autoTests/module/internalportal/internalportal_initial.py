...
print(' internal portal initialing ')
...
SetCmd(switch2,'enable')
SetCmd(switch2,'authentication-type internal')
SetCmd(switch2,'free-resource 1 destination ipv4 ' + StaticIpv4_ac2 +'/32 source any')
SetCmd(switch2,'configuration 1 ')
SetCmd(switch2,'enable')
SetCmd(switch2,'verification radius')
