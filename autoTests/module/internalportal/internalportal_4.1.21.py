...
testname = 'TestCase internalportal_4.1.21'
avoiderror(testname)
...
# AC1(config-cp-instance)#verfication radius
...
# AC1(config-cp-instance)#ac-name Ac1_name                                                                                     
...
SetCmd(switch1,'verfication radius')
...
#operate
res1 = WpaConnectWirelessNetwork(sta2,Netcard_sta2,Network_name2,checkDhcpAddress=Netcard_ipaddress_check2,bssid=ap2mac_type1_network2)
if res1 == 0:
    res2 = CheckWirelessClientOnline(switch1,sta1mac,'online')
#result
