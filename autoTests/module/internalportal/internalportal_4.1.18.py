...
#
# 4.1.18	客户端从开启portal认证的network切换到没有开启portal认证的网络

# 测试目的：客户端在开启portal认证和没有开启portal认证的网络之间切换时功能正常
# 测试描述：
# 1、	开启AP1对应network 2的vap 
# 2、	STA1连接到network1可以成功进行portal认证
# 3、	STA1不主动断开网络直接连接network2，AC1上表项正常
...
testname = 'TestCase internalportal_4.1.18'
avoiderror(testname)
