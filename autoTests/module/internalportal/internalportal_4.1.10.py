...
#
# Features:
# 4.1.10	WPA-Personal模式下客户端的内置portal认证
# 测试目的：验证SSID采用WPA-Personal加密后开启portal认证，客户端连接网络能够正常进行内置portal认证
# 测试描述：
# 1、	开启内置portal认证。
# 2、	修改network 1的加密方式为WPA
...
testname = 'TestCase internalportal_4.1.10'
avoiderror(testname)
