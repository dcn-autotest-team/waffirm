...
#
# Features:
# 4.1.11	WPA2-Personal模式下客户端内置portal认证
# 测试目的：验证SSID采用WPA2-Personal加密后开启portal认证，客户端连接网络能够正常进行内置portal认证
# 测试描述：
# 1、	开启内置portal认证。
# 2、	修改network1的加密方式为WPA2
...
testname = 'TestCase internalportal_4.1.11'
avoiderror(testname)
