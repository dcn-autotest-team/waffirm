...
# 测试描述：WPA-PSK-CCMP：client使用wpa-enterprise方式时（密码一致），关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.5.6'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa-psk CCMP mode mode when using wpa-enterprise auth method')
...
res1 = WpaConnectWirelessNetwork(sta1,Netcard_sta1,Network_name1,connectType='custom',
                                ...
                                key_mgmt='WPA-EAP',proto='WPA',pairwise='CCMP',
                                group='CCMP',eap='PEAP',
