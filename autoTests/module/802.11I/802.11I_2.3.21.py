...
# 测试描述： AP设置为WEP认证模式时，client使用wpa2-802.1x认证，关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.3.21'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wep shared-key mode when using wpa2-enterprise auth method')
