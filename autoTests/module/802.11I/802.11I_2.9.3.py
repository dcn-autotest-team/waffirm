...
#
# Features:
# 2.9.3  WPA2-PSK-CCMP：open方式关联失败
# 测试描述：WPA2-PSK-CCMP：client使用open方式时，关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.9.3'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa2-personal CCMP mode when using open auth method')
