...
# 测试描述：WPA2-802.1x-TKIP：client使用wpa2-enterprise方式，使用正确的用户名密码时，
...
testname = 'TestCase 802.11I_2.10.1'
avoiderror(testname)
printTimer(testname,'Start','Test wpa2-enterprise TKIP mode with wireless client')
...
#Step 2
#操作
#设置STA1无线网卡的属性为WPA2-Enterprise TKIP认证，关联网络test1，使用在Radius服务器配置的用户名和密码。
