...
#
# Features:
# 2.7.3 WPA-802.1x+TKIP：错误密码关联失败
# 测试描述：WPA-802.1x+TKIP：client使用wpa-enterprise方式，使用正确的用户名，错误的密码时，关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.7.3'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa-enterprise TKIP mode when using wrong key')
...
#Step 2
#操作
#设置STA1无线网卡的属性为WPA-Enterprise认证，输入正确的用户名和错误的密码，关联网络test1。
#预期
#关联失败
################################################################################
