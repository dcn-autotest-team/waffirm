...
# 测试描述： WPA2-802.1x-TKIP：client使用open方式时，关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.10.5'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa2-enterprise TKIP mode when using open auth method')
