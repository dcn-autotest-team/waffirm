...
#
# Features:
# 2.7.8 WPA-802.1x+TKIP：wpa2-enterprise方式关联失败
# 测试描述：WPA-802.1x+TKIP：client使用wpa2-enterprise方式时（用户名密码一致），关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.7.8'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa-enterprise TKIP mode when using using wpa2-enterprise auth method')
