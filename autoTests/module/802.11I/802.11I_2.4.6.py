...
#
# Features:
# 2.4.6  WPA-PSK-TKIP：wpa-enterprise方式关联失败
# 测试描述： client使用wpa-enterprise方式时（密码一致），关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.4.6'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa-psk TKIP mode mode when using wpa-enterprise auth method')
