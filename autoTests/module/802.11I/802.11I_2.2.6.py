...
#
# Features:
# 2.2.6 开放式认证+WEP加密：wpa2-psk认证无法关联成功
# 测试描述： 开放式认证+WEP加密：client使用wpa2-psk认证，使用正确的密钥无法关联成功
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.2.6'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wep open mode when using wpa2_psk auth method')
