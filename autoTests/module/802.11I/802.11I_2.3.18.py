...
# 测试描述： AP设置为WEP认证模式时，client使用WPA-PSK认证，密码和设置tx-key一致，关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.3.18'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wep shared-key mode when using wpa-psk auth method')
...
res1 = WpaConnectWirelessNetwork(sta1,Netcard_sta1,Network_name1,connectType='custom',
                                ...
                                psk=web_key4_ascii,bssid=ap1mac_type1)
