...
#
# Features:
# 2.8.4    WPA2-PSK-TKIP：wep方式关联失败
# 测试描述：  WPA2-PSK-TKIP：client使用wep方式时（密码一致），关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.8.4'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa2-personal TKIP mode when using wep shared auth method')
