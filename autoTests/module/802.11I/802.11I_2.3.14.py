...
#           客户端设置4个key为key5，key6，key7，key4，能够关联上AP，可以ping通AP
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.3.14'
avoiderror(testname)
printTimer(testname,'Start','Config four keys:key1,key2,key3,key4 in wep share key mode network1 \n \
                    and wep tx-key 4 on AC1\n \
                    Sta use four keys:key5,key6,key7,key4 to connect to network1 and connect successfully')
...
#Step 2
#操作
#设设置STA1为WEP Share Key认证，设置4各密码分别为key5,key6,key7,key4，关联test1
#
#预期
...
printStep(testname,'Step 2',\
          'STA1 config 4 keys:key5,key6,key7,key4 to connect to network 1,',\
          'connect success.')
res1=res2=1
# operate
res1 = WpaConnectWirelessNetwork(sta1,Netcard_sta1,Network_name1,connectType='custom',
                                ...
                                wep_key2=web_key7_ascii,wep_key3=web_key4_ascii,wep_tx_keyidx='3',
