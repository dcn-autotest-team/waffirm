...
#           客户端设置4个key为key1，key2，key3，key5，不能关联上AP
#*******************************************************************************
# Change log:
...
#Step 2
#操作
#设设置STA1为WEP Share Key认证，设置4各密码分别为key1,key2,key3,key5，关联test1
#
#预期
#关联失败。
################################################################################
printStep(testname,'Step 2',\
          'STA1 config 4 keys:key1,key2,key3,key5 to connect to network 1,',\
          'connect failed.')
res1=1
# operate
res1 = WpaConnectWirelessNetwork(sta1,Netcard_sta1,Network_name1,connectType='custom',
                                ...
                                wep_key2=web_key3_ascii,wep_key3=web_key5_ascii,wep_tx_keyidx='3',
                                bssid=ap1mac_type1)
