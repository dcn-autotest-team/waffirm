...
# 测试描述：  WPA2-802.1x-TKIP：client使用wpa2-psk方式时（用户名密码一致），关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.10.7'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa2-enterprise TKIP mode when using wpa2-psk auth method')
...
res1 = WpaConnectWirelessNetwork(sta1,Netcard_sta1,Network_name1,connectType='custom',
                                ...
                                key_mgmt='WPA-PSK',proto='WPA2',pairwise='TKIP',
                                group='TKIP',psk='admin@123',
                                bssid=ap1mac_type1)
