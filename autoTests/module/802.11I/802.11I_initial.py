...
SetCmd(switch1,'vlan',Vlan10+';'+Vlan4091)
#vlan10
...
IdleAfter(Vlan_Idle_time)
SetIpAddress(switch1,If_vlan4091_s1_ipv4,'255.255.255.0')
# loopback1
...
SetCmd(switch1,'switch trunk native vlan',Vlan10)
#配置router rip
EnterConfigMode(switch1)
...
SetCmd(switch1,'ip dhcp conflict ping-detection enable')
...
SetCmd(switch3,'vlan',Vlan10+';'+Vlan20+';'+Vlan192+';'+Vlan4091)
#vlan10
...
SetCmd(switch3,'switch trunk native vlan',Vlan10)
# s3p3
EnterConfigMode(switch3)
...
SetCmd(switch3,'switch access vlan',Vlan192)
#router rip
EnterConfigMode(switch3)
