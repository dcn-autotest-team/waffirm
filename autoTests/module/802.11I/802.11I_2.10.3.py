...
# 测试描述：WPA2-802.1x-TKIP：client使用wpa2-enterprise方式，使用正确的用户名，错误的密码时，关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.10.3'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa2-enterprise TKIP mode when using wrong key')
