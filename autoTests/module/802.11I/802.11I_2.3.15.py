...
#           客户端设置4个key为key7，key5，key4，key6，不能关联上AP
#*******************************************************************************
# Change log:
...
#Global Definition
web_key5_ascii,web_key6_ascii,web_key7_ascii='22222','55555','11111'
#Source files
...
#Step 2
#操作
#设设置STA1为WEP Share Key认证，设置4各密码分别为key7,key5,key4,key6，关联test1
#
#预期
#关联失败。
################################################################################
printStep(testname,'Step 2',\
          'STA1 config 4 keys:key7,key5,key4,key6 to connect to network 1,',\
          'connect failed.')
res1=1
# operate
res1 = WpaConnectWirelessNetwork(sta1,Netcard_sta1,Network_name1,connectType='custom',
                                ...
                                wep_key0=web_key7_ascii,wep_key1=web_key5_ascii,
                                wep_key2=web_key4_ascii,wep_key3=web_key6_ascii,wep_tx_keyidx='3',
                                bssid=ap1mac_type1)
