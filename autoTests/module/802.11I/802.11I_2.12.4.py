...
#
# Features:
# 2.12.4 Wpa Enterprise： wpa和wpa2共存，wep方式时关联失败
# 测试描述：设置AP为wpa和wpa2共存，client使用wep方式时（密码一致），关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.12.4'
avoiderror(testname)
printTimer(testname,'Start','client connect to ap with wpa/wpa2-enterprise mode when using wep shared auth method')
