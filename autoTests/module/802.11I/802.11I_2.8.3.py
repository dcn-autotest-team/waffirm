...
#
# Features:
# 2.8.3    WPA2-PSK-TKIP：open方式关联失败
# 测试描述：  WPA2-PSK-TKIP：client使用open方式时，关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.8.3'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa2-personal TKIP mode when using open auth method')
