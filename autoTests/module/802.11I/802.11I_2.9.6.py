...
#
# Features:
# 2.9.6  WPA2-PSK-CCMP：wpa-enterprise方式关联失败
# 测试描述： WPA2-PSK-CCMP：client使用wpa-enterprise方式时（密码一致），关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.9.6'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa2-personal CCMP mode when using wpa-enterprise auth method')
