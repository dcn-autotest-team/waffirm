...
# 测试描述：WPA2-802.1x-CCMP：client使用wpa2-enterprise方式，使用正确的用户名，错误的密码时，关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.11.3'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa2-enterprise CCMP mode when using wrong key')
...
#Step 2
#操作
#设置STA1无线网卡的属性为WPA2-Enterprise认证，输入正确的用户名和错误的密码，关联网络test1。
#预期
#关联失败
################################################################################
...
res1 = WpaConnectWirelessNetwork(sta1,Netcard_sta1,Network_name1,connectType='custom',
                                ...
                                eap='PEAP',identity=Dot1x_identity,password='888888',
                                bssid=ap1mac_type1)
