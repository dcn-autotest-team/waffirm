...
#
# Features:
# 2.8.2   WPA2-PSK-TKIP：错误密码关联失败
# 测试描述：  WPA2-PSK-TKIP：client使用wpa2-psk方式，使用错误的密码时，关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.8.2'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa2-personal TKIP mode when using wrong key')
...
#Step 2
#操作
#设置STA1无线网卡的属性为WPA2-PSK认证，输入错误的密码，关联网络test1。
#预期
#关联失败
################################################################################
...
res1 = WpaConnectWirelessNetwork(sta1,Netcard_sta1,Network_name1,connectType='custom',
                                ...
                                proto='WPA2', pairwise='TKIP',group='TKIP', psk='abcd1233',
                                bssid=ap1mac_type1)
