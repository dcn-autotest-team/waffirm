...
#
# Features:
# 2.12.1 Wpa Enterprise：wpa和wpa2共存，wpa方式可以成功关联
# 测试描述：当设置为wpa和wpa2共存，client使用wpa方式可以成功关联（正确用户名密码）
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.12.1'
avoiderror(testname)
printTimer(testname,'Start','client connect to ap with wpa/wpa2-enterprise mode when using wpa-enterprise auth method')
