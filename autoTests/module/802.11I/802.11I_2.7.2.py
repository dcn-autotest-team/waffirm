...
#
# Features:
# 2.7.2 WPA-802.1x+TKIP：错误用户名关联失败
# 测试描述：WPA-802.1x+TKIP：client使用wpa-enterprise方式，使用错误的用户名，正确的密码时，关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.7.2'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa-enterprise TKIP mode when using wrong username')
...
#Step 2
#操作
#设置STA1无线网卡的属性为WPA-Enterprise认证，输入错误的用户名和正确的密码，关联网络test1。
#预期
#关联失败
################################################################################
