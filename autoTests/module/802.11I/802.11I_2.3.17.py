...
# 测试描述：AP设置为WEP认证模式时，client使用开放式认证，关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.3.17'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wep shared-key mode when using open auth method')
