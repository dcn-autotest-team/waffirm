...
#
# Features:
# 2.3.2  WEP加密的Share Key：密钥匹配
# 测试描述：设置wep的4个key分别为key1，key2，key3，key4，设置认证加密使用key1，
#           客户端设置4个key为key1，key5，key6，key7，能够关联上AP，可以ping通AP
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.3.2'
avoiderror(testname)
printTimer(testname,'Start','Config four keys:key1,key2,key3,key4 in wep share key mode network1 on AC1\n \
                    Sta use four keys:key1,key5,key6,key7 to connect to network1 and connect successfully')
...
#Step 2
#操作
#设设置STA1为WEP Share Key认证，设置4各密码分别为key1,key5,key6,key7，关联test1
#
#预期
...
printStep(testname,'Step 2',\
          'STA1 config 4 keys:key1,key5,key6,key7 to connect to network 1,',\
          'connect success.')
res1=res2=1
# operate
res1 = WpaConnectWirelessNetwork(sta1,Netcard_sta1,Network_name1,connectType='custom',
                                ...
                                wep_key2=web_key6_hex,wep_key3=web_key7_hex,wep_tx_keyidx='0',
