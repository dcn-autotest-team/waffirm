...
# 测试描述：WPA2-802.1x-CCMP：client使用wpa-psk方式，使用正确的用户名密码时，关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.11.4'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa2-enterprise CCMP mode when using wpa-psk auth method')
