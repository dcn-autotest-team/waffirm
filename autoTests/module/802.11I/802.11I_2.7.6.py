...
#
# Features:
# 2.7.6 WPA-802.1x+TKIP：wep方式关联失败
# 测试描述：WPA-802.1x+TKIP：client使用wep方式时（密码一致），关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.7.6'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa-enterprise TKIP mode when using using wep shared auth method')
