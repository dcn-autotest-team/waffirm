...
#
# Features:
# 2.4.5  WPA-PSK-TKIP：wpa2-psk方式关联失败
# 测试描述：client使用wpa2-psk方式时（密码一致），关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.4.5'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa-psk TKIP mode mode when using wpa2-psk auth method')
