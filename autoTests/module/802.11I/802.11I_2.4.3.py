...
#
# Features:
# 2.4.3  WPA-PSK-TKIP：open方式关联失败
# 测试描述： client使用open方式时，关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.4.3'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa-psk TKIP mode when using open auth method')
