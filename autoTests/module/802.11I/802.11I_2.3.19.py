...
# 测试描述：AP设置为WEP认证模式时，client使用WPA2-PSK认证，密码和设置tx-key一致，关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.3.19'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wep shared-key mode when using wpa2-psk auth method')
