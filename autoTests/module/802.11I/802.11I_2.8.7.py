...
#
# Features:
# 2.8.7   WPA2-PSK-TKIP：wpa2-enterprise方式关联失败
# 测试描述：  WPA2-PSK-TKIP：client使用wpa2-enterprise方式时（密码一致），关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.8.7'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa2-personal TKIP mode when using wpa2-enterprise auth method')
...
res1 = WpaConnectWirelessNetwork(sta1,Netcard_sta1,Network_name1,connectType='custom',
                                ...
                                key_mgmt='WPA-EAP',proto='WPA2',pairwise='TKIP',
                                group='TKIP',eap='PEAP',
                                identity=Dot1x_identity,password='abcd1234',
                                bssid=ap1mac_type1)
