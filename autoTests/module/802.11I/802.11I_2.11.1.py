...
# 测试描述：WPA2-802.1x-CCMP：client使用wpa2-enterprise方式，使用正确的用户名密码时，
#           能够关联成功，AP和client相互通信能够正常加解密
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.11.1'
avoiderror(testname)
printTimer(testname,'Start','Test wpa2-enterprise CCMP mode with wireless client')
...
#Step 2
#操作
#设置STA1无线网卡的属性为WPA2-Enterprise CCMP认证，关联网络test1，使用在Radius服务器配置的用户名和密码。
