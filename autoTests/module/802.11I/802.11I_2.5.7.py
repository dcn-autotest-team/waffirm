...
# 测试描述： WPA-PSK-CCMP：client使用wpa2-enterprise方式时（密码一致），关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.5.7'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa-psk CCMP mode mode when using wpa2-enterprise auth method')
