...
#
# Features:
# 2.8.1   WPA2-PSK-TKIP：关联成功，正常加解密
# 测试描述： WPA2-PSK-TKIP：client使用wpa2-psk方式，使用正确的密码时，能够关联成功，AP和client相互通信能够正常加解密
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.8.1'
avoiderror(testname)
printTimer(testname,'Start','Test wpa2-personal TKIP mode with wireless client')
...
res1 = WpaConnectWirelessNetwork(sta1,Netcard_sta1,Network_name1,connectType='custom',
                                key_mgmt='WPA-PSK',proto='WPA2',pairwise='TKIP',group='TKIP',psk='abcd1234',
