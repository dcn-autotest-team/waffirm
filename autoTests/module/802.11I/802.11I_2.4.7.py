...
#
# Features:
# 2.4.7  WPA-PSK-TKIP：wpa2-enterprise方式关联失败
# 测试描述： client使用wpa2-enterprise方式时（密码一致），关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.4.7'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa-psk TKIP mode mode when using wpa2-enterprise auth method')
...
res1 = WpaConnectWirelessNetwork(sta1,Netcard_sta1,Network_name1,connectType='custom',
                                ...
                                key_mgmt='WPA-EAP',proto='WPA2',pairwise='CCMP',
                                group='CCMP',eap='PEAP',
