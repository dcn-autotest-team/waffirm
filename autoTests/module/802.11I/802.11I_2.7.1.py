...
#
# Features:
# 2.7.1 WPA-802.1x+TKIP：关联成功，正常加解密
# 测试描述：WPA-802.1x+TKIP：client使用wpa-enterprise方式，使用正确的用户名密码时，
...
testname = 'TestCase 802.11I_2.7.1'
avoiderror(testname)
printTimer(testname,'Start','Test wpa-enterprise TKIP mode with wireless client')
