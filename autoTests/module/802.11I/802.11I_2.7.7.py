...
#
# Features:
# 2.7.7 WPA-802.1x+TKIP：wpa2-psk方式关联失败
# 测试描述：WPA-802.1x+TKIP：client使用wpa2-psk方式时（用户名密码一致），关联失败
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.7.7'
avoiderror(testname)
printTimer(testname,'Start','client can not connect to ap with wpa-enterprise TKIP mode when using using wpa2-psk auth method')
