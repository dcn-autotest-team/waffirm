...
#
# Features:
# 2.1.2 WEP模式下客户端认证接入测试
# 测试描述：无线系统采用WEP方式时，client使用WEP能够认证成功
#*******************************************************************************
# Change log:
...
testname = 'TestCase 802.11I_2.1.2'
avoiderror(testname)
...
res1 = WpaConnectWirelessNetwork(sta1,Netcard_sta1,Network_name1,connectType='custom',
                                key_mgmt='NONE',wep_key0=web_key1_ascii,wep_tx_keyidx='0',
