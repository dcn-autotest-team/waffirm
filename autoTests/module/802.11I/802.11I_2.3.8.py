...
#
# Features:
# 2.3.8 WEP加密的Share Key：密钥匹配
# 测试描述：设置wep的4个key分别为key1，key2，key3，key4，设置认证加密使用key2，
#           客户端设置4个key为key1，key5，key3，key4，不能关联上AP
#*******************************************************************************
# Change log:
...
#Step 2
#操作
#设设置STA1为WEP Share Key认证，设置4各密码分别为key1,key5,key3,key4，关联test1
#
#预期
#关联失败。
################################################################################
printStep(testname,'Step 2',\
          'STA1 config 4 keys:key1,key5,key3,key4 to connect to network 1,',\
          'connect failed.')
res1=1
# operate
res1 = WpaConnectWirelessNetwork(sta1,Netcard_sta1,Network_name1,connectType='custom',
                                ...
                                wep_key0=web_key1_hex,wep_key1=web_key5_hex,
                                wep_key2=web_key3_hex,wep_key3=web_key4_hex,wep_tx_keyidx='1',
                                bssid=ap1mac_type1)
