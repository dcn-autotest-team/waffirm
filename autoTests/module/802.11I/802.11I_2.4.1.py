...
testname = 'TestCase 802.11I_2.4.1'
avoiderror(testname)
printTimer(testname,'Start','Test wpa-personal TKIP mode with wireless client')
...
res1 = WpaConnectWirelessNetwork(sta1,Netcard_sta1,Network_name1,connectType='custom',
                                key_mgmt='WPA-PSK',proto='WPA', pairwise='TKIP',group='TKIP', psk='abcd1234',
