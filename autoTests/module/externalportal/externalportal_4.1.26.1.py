...
#
# Features:
# 4.1.26.1	 AP逃生客户端不下线场景下的portal认证
# 测试目的：开启AP逃生功能，AP逃生后，AP直接放行客户端流量
# 测试描述：
# 1.	开启AP逃生功能，客户端STA1连接到无线网络成功进行portal认证
# 2.	AP逃生后，STA2连接到无线网络
# 3.	AP逃生恢复后，检查客户端STA1和STA2是否放行客户端流量
# 测试环境：见测试环境拓扑图1
#*******************************************************************************
# Change log:
...
testname = 'TestCase externalportal_4.1.26.1'
avoiderror(testname)
