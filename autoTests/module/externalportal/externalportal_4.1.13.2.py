...
#
# Features:
# 4.1.13.2	WPA2-Personal模式下客户端外置portal认证（2.4GHz覆盖）
# 测试目的：验证SSID采用WPA2-Personal加密后开启portal认证，客户端连接网络能够正常进行外置portal认证
# 测试描述：
# 1.	修改network1的加密方式为WPA2
...
testname = 'TestCase externalportal_4.1.13.2'
avoiderror(testname)
printTimer(testname,'Start','Test portal with wpa2-personal mode')
###############################################################################
#Step 1(合并方案step1,2)
#操作
...
################################################################################
printStep(testname,'Step 1 Step2',\
