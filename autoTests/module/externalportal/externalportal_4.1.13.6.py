...
#
# Features:
# 4.1.13.6	WPA/WPA2-Enterprise混合模式下客户端外置portal认证(2.4GHz覆盖)
# 测试目的：验证SSID采用WPA/WPA2-Enterprise加密后开启portal认证，客户端连接网络能够正常进行外置portal认证
# 测试描述：
# 1.	修改network1的加密方式为WPA/WPA2-Enterprise
...
testname = 'TestCase externalportal_4.1.13.6'
avoiderror(testname)
