...
#
#*******************************************************************************
# apconfiguration_2.2.3.17_ONE.py
#
# Author: zhangjxp
#
# Version 1.0.0
...
#
# Features: 
# 2.2.3.17	Controller分组独立升级Abort测试1
# 测试目的： 
...
testname = 'apconfiguration_2.2.3.17'
avoiderror(testname)
...
printStep(testname,'Step 2',
          ...
          'controller abort ap download when ap1 is in Code Transfer In Progress status and ap2 is in Requested status',
