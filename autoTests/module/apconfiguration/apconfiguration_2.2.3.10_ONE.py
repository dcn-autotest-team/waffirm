...
#
#*******************************************************************************
# apconfiguration_2.2.3.10_ONE.py
#
# Author: zhangjxp
#
# Version 1.0.0
...
#
# Features: 
# 2.2.3.10-11	Controller上可以同时升级所有Ap(合并用例2.2.3.10和2.2.3.11)
# 测试目的： 
# 2.2.3.10 Controller上可以wireless ap download start 触发手动独立升级所有ap，自己管理ap重启后被AC管理，image版本已经更新成功。
...
testname = 'apconfiguration_2.2.3.10-11'
avoiderror(testname)
printTimer(testname,'Start','controller can upgrade all aps which are managed by controller and peers')
###############################################################################
#Step 1
#操作
