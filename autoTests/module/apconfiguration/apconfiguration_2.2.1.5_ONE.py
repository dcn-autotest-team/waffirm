...
#
# Features:
# 2.2.1.5	Controler上可以指定peer上ap重启
# 测试目的：Controller上可以wireless ap reset <ap1_mac>重启指定peer上ap1，ap1重启后重新上线，被AC管理。
#
#*******************************************************************************
# Change log:
...
testname = 'apconfiguration_2.2.1.5'
avoiderror(testname)
printTimer(testname,'Start','ac(controller) can reset the aps that are managed by peers')
