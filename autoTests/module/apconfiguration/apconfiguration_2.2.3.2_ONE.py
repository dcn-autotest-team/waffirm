...
#
#*******************************************************************************
# apconfiguration_2.2.3.2_ONE.py
#
# Author: zhangjxp
#
# Version 1.0.0
...
#
# Features: 
# 2.2.3.2-3	为AP指定Image并手动更新(合并用例2.2.3.2和2.2.3.3)
# 测试目的： 
# 2.2.3.2 Controller上可以wireless ap download start <ap1_mac>触发手动独立升级ap1 image,ap1重启后被AC管理，image版本已经更新成功。
...
testname = 'apconfiguration_2.2.3.2'
avoiderror(testname)
printTimer(testname,'Start','controller can  upgrade ap1 version, and ap2 should not upgrade ')
###############################################################################
#Step 1
#操作
...
printStep(testname,'Step 3',
          'controller config ap1 upgrade image to ap1_current_build',
          'controller upgrade ap1',
          'ap1 upgrade successfully')
