...
#
#*******************************************************************************
# waffirm_6.3.1.py - test case 6.3.1 of waffirm
#
# Author: 
#
# Version 1.0.0
...
#
# Features:
# 6.3.1 management vlan 和untag vlan不相同情况下的外置Portal功能测试
# 测试目的：测试management vlan 和untag vlan不相同情况下的外置portal 认证测试
# 测试环境：同测试拓扑
# 测试描述：测试ap management vlan 和untag vlan不相同情况下客户端发起HTTP请求时，能够成功重定向到外置Portal的认证页面，客户端能够成功的上/下线
#          （STA1的MAC地址：STA1MAC）
#
#*******************************************************************************
# Change log:
