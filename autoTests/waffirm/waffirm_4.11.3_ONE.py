...
data1 = SetCmd(pc1,'snmpwalk -v 2c -c public ' + StaticIpv4_ac1 +  ' ' + oid + '.103.1.3.8.1.3',timeout=15)
...
data1 = SetCmd(pc1,'snmpwalk -v 2c -c public ' + StaticIpv4_ac1 +  ' ' + oid + '.103.1.3.8.1.4',timeout=15)
