...
res1 = CheckLineList(data1, ['radius source-ipv4 ' + StaticIpv4_ac1, 'radius-server key 0 test',
                             'radius-server authentication host ' + Radius_server,
                             'radius-server accounting host ' + Radius_server, 'aaa-accounting enable', 'aaa enable',
                             'radius nas-ipv4 ' + StaticIpv4_ac1,
...
# SetCmd(ap1,'admin')
# SetCmd(ap1,'iwconfig')
res1 = WpaConnectWirelessNetwork(sta1, Netcard_sta1, Network_name1, connectType='wpa2_eap', identity=Dot1x_identity,
                                 password=Dot1x_password, checkDhcpAddress=Netcard_ipaddress_check, bssid=ap1mac_lower)
...
res1 = WpaConnectWirelessNetwork(sta1, Netcard_sta1, Network_name1, connectType='wpa_eap', identity=Dot1x_identity,
                                 password=Dot1x_password, checkDhcpAddress=Netcard_ipaddress_check, bssid=ap1mac_lower)
