...
#Step 1
#操作
#确保ap1和ap2被ac1管理，并且被分别管理到profile 1和profile2下面。两个ap有相同的ssid：test
...
res1 = WpaConnectWirelessNetwork(sta1,Netcard_sta1,Network_name1,connectType='wpa_psk',psk=Network_wpa_password,checkDhcpAddress=Netcard_ipaddress_check,bssid=ap1mac_lower)
...
if GetWhetherkeepon(keeponflag):
    ...
    res1 = WpaConnectWirelessNetwork(sta2,Netcard_sta2,Network_name1,connectType='wpa_psk',psk=Network_wpa_password,checkDhcpAddress=Netcard_ipaddress_check,bssid=ap1mac_lower)
