...
#
#*******************************************************************************
# waffirm_4.17.1.py - test case 4.17.1 of waffirm
#
...
#Functional Code
if ac1type != '508':
    testname = 'TestCase 4.17.1'
    avoiderror(testname)
    printTimer(testname,'Start','Test PPPoE server-PAP')
    ...
    SetCmd(switch1,'ip address ' + If_vlan4091_s1_ipv4 + ' 255.255.255.0')
    SetCmd(switch1,'ppp authentication-mode pap')
