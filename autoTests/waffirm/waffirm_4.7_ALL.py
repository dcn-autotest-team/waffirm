...
data2 = ShowRun(switch3)
# 集中转发、本地转发差异化配置，testcentral为True代表集中转发配置，False代表本地转发配置
if testcentral:
    res1 = CheckLineInOrder(data1,['interface Vlan40','ip pim dense-mode'],IC=True)
    res2 = CheckLineInOrder(data1,['interface Vlan4091','ip pim dense-mode'],IC=True)
else:
    res1=res2=0
res3 = CheckLineInOrder(data2,['interface Vlan20','ip pim dense-mode'],IC=True)
res4 = CheckLineInOrder(data2,['interface Vlan40','ip pim dense-mode'],IC=True)
res5 = CheckLineInOrder(data2,['interface Vlan192','ip pim dense-mode'],IC=True)
