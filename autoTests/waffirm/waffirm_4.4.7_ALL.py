...
while i_times < 10:
    ...
    if 0 == CheckLine(data1, sta1mac, ap1vapmac, Network_name1, 'Auth', IC=True):
        res2 = 0
        break
    IdleAfter(5)
    i_times += 1
...
# operate
WpaConnectWirelessNetwork(sta1, Netcard_sta1, Network_name1, dhcpFlag=False, bssid=ap1mac_lower)
WpaConnectWirelessNetwork(sta2, Netcard_sta2, Network_name1, dhcpFlag=False, bssid=ap1mac_lower)
...
# operate
IdleAfter(120)
res1 = WpaConnectWirelessNetwork(sta2, Netcard_sta2, Network_name1, reconnectflag=0, bssid=ap1mac_lower)
...
# check
res2 = CheckNoLineList(data1, [(sta1mac, ap1vapmac, Network_name1, 'Auth')], IC=True)
...
####while i_times < 100: 
####    data1 = SetCmd(switch1,'show wireless dynamic-blacklist')
####    if 0 == CheckNoLineList(data1,[(sta1mac),(sta2mac)],IC=True):
####        printRes('Total time cost: '+ str(i_times*6))
####        break
####    i_times += 1
####    IdleAfter(5)
##    
