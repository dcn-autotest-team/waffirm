...
class selenium(object):
    ...
    *   \ **exact:**\ \ *string*:
    ...
    def allow_native_xpath(self, allow):
        ...
        this function, we will always use our pure-JavaScript xpath dcntestlibrary.
        Using the pure-JS xpath dcntestlibrary can improve the consistency of xpath
    ...
    def use_xpath_library(self, libraryName):
        ...
        'libraryName' is name of the desired dcntestlibrary Only the following three can be chosen:
        *   "ajaxslt" - Google's dcntestlibrary
        *   "javascript-xpath" - Cybozu Labs' faster dcntestlibrary
        *   "default" - The default dcntestlibrary.  Currently the default dcntestlibrary is "ajaxslt" .
