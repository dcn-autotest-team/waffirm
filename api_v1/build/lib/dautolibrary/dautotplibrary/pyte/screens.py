...
class Screen(object):
    ...
    def reset(self):
        ...
        * All lines are marked as :attr:`dirty`.
        ...
        """
        self.dirty.update(list(range(self.lines)))
        self.buffer.clear()
        self.margins = None
    ...
    def resize(self, lines=None, columns=None):
        ...
        self.dirty.update(list(range(lines)))
        ...
        if columns < self.columns:
            for line in list(self.buffer.values()):
    ...
    def insert_lines(self, count=None):
        ...
        if top <= self.cursor.y <= bottom:
            self.dirty.update(list(range(self.cursor.y, self.lines)))
    ...
    def erase_in_line(self, how=0, private=False):
        ...
        self.dirty.add(self.cursor.y)
        if how == 0:
            interval = list(range(self.cursor.x, self.columns))
        elif how == 1:
            interval = list(range(self.cursor.x + 1))
        elif how == 2:
            interval = list(range(self.columns))
    ...
    def erase_in_display(self, how=0, private=False):
        ...
        """
        if how == 0:
            interval = list(range(self.cursor.y + 1, self.lines))
        elif how == 1:
            interval = list(range(self.cursor.y))
        elif how == 2 or how == 3:
            interval = list(range(self.lines))
