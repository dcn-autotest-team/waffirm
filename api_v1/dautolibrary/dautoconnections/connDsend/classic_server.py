...
import rpyc
# from rpyc.utils.authenticators import *
...
parser.add_option("-m", "--mode", action="store", dest="mode", metavar="MODE",
                  default="threaded", type="string", help="mode can be 'threaded', 'forking', "
                                                          "or 'stdio' to operate over the standard IO pipes (for "
                                                          "inetd, etc.). "
                                                          "Default is 'threaded'")
...
parser.add_option("--host", action="store", dest="host", type="str",
                  metavar="HOST", default="10.1.145.136", help="specify a different "
...
def get_options():
    ...
    #     options.authenticator = VdbAuthenticator(options.vdbfile, mode = "r")
    # else:
